...
THEN FIX the error.  Use `context7`,`brave-search`, `zen-mcp' or any other MCPs to understand the error.
THEN re-run the command in the terminal.  If there is another error, repeat this debugging process.
USE any Sub-Agents as you fit for architecture review, debugging and re-coding

...
- You must comply with documentation and rules set forth here strictly.
- All documentation goes under `docs/` directory
- All tests and test scripts go under `tests/` directory
...
- Write tests and accommodating Markdown files in the project root directory
